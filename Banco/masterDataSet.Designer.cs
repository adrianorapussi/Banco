...
namespace Banco {
    ...
    public partial class masterDataSet : global::System.Data.DataSet {
        ...
        public partial class TesteDataTable : global::System.Data.TypedTableBase<TesteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TesteRow AddTesteRow(int id, string nome, string sobrenome, System.DateTime horario) {
        ...
        public partial class TesteRow : global::System.Data.DataRow {
            ...
            public System.DateTime horario {
                get {
                    return ((global::System.DateTime)(this[this.tableTeste.horarioColumn]));
                }
                set {
                    this[this.tableTeste.horarioColumn] = value;
                }
            }
...
namespace Banco.masterDataSetTableAdapters {
    ...
    public partial class TesteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Teste] WHERE (([id] = @Original_id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_sobrenome = 1 AND [sobrenome] IS NULL) OR ([sobrenome] = @Original_sobrenome)) AND ([horario] = @Original_horario))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Teste] ([id], [nome], [sobrenome], [horario]) VALUES (@id, @no" +
                "me, @sobrenome, @horario);\r\nSELECT id, nome, sobrenome, horario FROM Teste WHERE" +
                " (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Teste] SET [id] = @id, [nome] = @nome, [sobrenome] = @sobrenome, [horario] = @horario WHERE (([id] = @Original_id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_sobrenome = 1 AND [sobrenome] IS NULL) OR ([sobrenome] = @Original_sobrenome)) AND ([horario] = @Original_horario));
SELECT id, nome, sobrenome, horario FROM Teste WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Banco.Properties.Settings.Default.masterTesteConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nome, sobrenome, horario FROM dbo.Teste";
        ...
        public virtual int Fill(masterDataSet.TesteDataTable dataTable) {
        ...
        public virtual masterDataSet.TesteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet.TesteDataTable dataTable = new masterDataSet.TesteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet.TesteDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nome, string Original_sobrenome, System.DateTime Original_horario) {
        ...
        public virtual int Insert(int id, string nome, string sobrenome, System.DateTime horario) {
        ...
        public virtual int Update(int id, string nome, string sobrenome, System.DateTime horario, int Original_id, string Original_nome, string Original_sobrenome, System.DateTime Original_horario) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string sobrenome, System.DateTime horario, int Original_id, string Original_nome, string Original_sobrenome, System.DateTime Original_horario) {
            return this.Update(Original_id, nome, sobrenome, horario, Original_id, Original_nome, Original_sobrenome, Original_horario);
        }
    }
